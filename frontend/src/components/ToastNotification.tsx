...
const ToastNotification: React.FC<ToastNotificationProps> = ({vacation}) => {
    ...
    <div className="ms-3 text-sm font-normal">Item Created. Go to <a className="underline hover:cursor-pointer" onClick={(() => navigate(`/vacations/${vacation?.id}`))}>{vacation?.city}'s Itinerary</a></div>
